        ...
        <div className="flex items-center justify-between pt-2 border-t border-slate-800 gap-2">
          ...
          {activeToast.actionLabel && (
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold flex items-center gap-1.5 shadow-md shadow-emerald-600/30 transition-all"
            >
